...
2. **Team handoff email** — drafted directly in Gmail (Phase 4C), with a markdown copy archived at
   `G:\Shared drives\{Client Legal Name}\Perm File\Onboarding Dossier - {Client Legal Name}.md`.
...
- **2026-09-08** — Prep-notes/Dossier duplication resolved: merged back into a single file named **Onboarding Dossier**, reusing the retired dashboard's name. The team handoff email no longer gets its own Perm File archive — it points at the Dossier instead.
